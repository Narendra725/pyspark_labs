...
def delete_directory(directory):
    if os.path.isdir(directory):
        try:
            ...
            print(GREEN+f"Directory '{directory.split('\\')[-1]}' has been deleted."+RESET)
        except Exception as e:
...
def create_skeleton_for_page(page_name,display_name,pages_folder):
    ...
    page_data = read_json(r"C:\Nahdi-articrafts\REPORT_AUTOMATION\base_articrafts\report_page_jsons\page.json")
    ...
    page_base_visuals = r"C:\Nahdi-articrafts\REPORT_AUTOMATION\base_articrafts\report_page_jsons\visuals"
    page_visuals = f"{pages_folder}\\{page_name}\\visuals"
    create_folder(page_visuals)

    visuals = [ "_logo_visual",
                "_chapter_header",
                "_dashboard_name_box",
                "_home_button",
                "_sub_header_box",
...
def create_page_navigation(pages_folder,page_name,data):
    create_folder(f"{pages_folder}\\{page_name}\\visuals\\_page_navigator")
    create_or_replace_file(f"{pages_folder}\\{page_name}\\visuals\\_page_navigator\\visual.json",data)
    return
...
def get_page_navigation_json(chapter_name,report_struct):
    base_page_navigation = r"C:\Nahdi-articrafts\REPORT_AUTOMATION\base_articrafts\report_page_jsons\visuals\_page_navigator\visual.json"
...
def get_chapter_button_visuals(report_struct):
    ...
    for chapter in report_struct.keys():
        base_chapter_button_json = read_json(r"C:\Nahdi-articrafts\REPORT_AUTOMATION\base_articrafts\report_page_jsons\visuals\_chapter_button\visual.json")
...
def create_homepage(report_struct,pages_folder):
    base_loc = r"C:\Nahdi-articrafts\REPORT_AUTOMATION\base_articrafts\home_page_jsons"
